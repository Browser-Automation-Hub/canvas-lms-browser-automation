/**
 * auth.js — Authentication handler for Canvas LMS
 * Supports: SSO (SAML / Google / Okta), MFA (Duo / Okta MFA)
 *
...
const BASE_URL = process.env.CANVAS_URL || 'https://your-school.instructure.com/login';
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set CANVAS_USERNAME and CANVAS_PASSWORD in .env`);
  }

  console.log('Logging in to Canvas LMS...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });
